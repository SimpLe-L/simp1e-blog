...
import { DonationRes, DonationsArr } from '@/types';
...
const CampaignDetails = () => {
  ...
  const [donators, setDonators] = useState<DonationsArr>([]);
        ...
        <div className="flex-[2] flex flex-col gap-[40px]">
          ...
          <div>
            ...
            <div className="mt-[20px] flex flex-col gap-4">
              {donators.length > 0 ? donators.map((item: DonationRes, index: number) => (
